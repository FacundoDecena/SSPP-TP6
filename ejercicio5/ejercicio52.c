...
int main(int argc, char** argv){
    ...
    // Divide in columns
    FMPI_Scatter(matrix, size, MPI_INT, column, size, MPI_INT, 0, MPI_COMM_WORLD);
    // Share the vector
    FMPI_Bcast(vector, size, MPI_INT, 0, MPI_COMM_WORLD);
    ...
    FMPI_Gather(&res, 1, MPI_INT, sub_total, 1, MPI_INT, 0, MPI_COMM_WORLD);
